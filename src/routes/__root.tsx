...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mulugu Hotel & Restaurant — Luxury Stay in Telangana" },
      { name: "description", content: "Premium luxury stay, family restaurant and tourism in Mulugu, Telangana. Book rooms, dine, and explore." },
